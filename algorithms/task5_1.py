...
print(f'Предприятия, прибыль которых больше или равна средней: {list(enterprises.most_common(count_))}')
print(
    f'Предприятия, прибыль которых меньше средней: {list(enterprises.most_common()[:-(number_company + 1 - count_):-1])}')
